...
model_dir = '/Users/ruchit/urop/model/'
...
if finer_annotation_dir:
    ...
    finer_train_loader = torch.utils.data.DataLoader(
        finer_train_dataset, batch_size=10, shuffle=True, num_workers=0, pin_memory=False)
...
for epoch in range(num_train_epochs):
    ...
    auc, _ = tnt.test(model=ppnet_multi, dataloader=test_loader,
